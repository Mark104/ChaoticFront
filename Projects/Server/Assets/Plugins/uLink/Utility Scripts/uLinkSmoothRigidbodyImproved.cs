...
public class uLinkSmoothRigidbodyImproved : uLink.MonoBehaviour
{
	...
	[RPC]
	public void SendInput(Vector2 _Position,Vector2 _Velocity,short _Rot,uLink.NetworkMessageInfo info)
	{
		
		transform.position = new Vector3(_Position.x,0,_Position.y);
		transform.rotation = Quaternion.Euler(new Vector3(0,_Rot,0));
